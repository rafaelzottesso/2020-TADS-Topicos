...
urlpatterns = [
    ...
    path('editar/campus/', CampusUpdate.as_view(), name="editar-campus"),
    path('editar/status/', StatusUpdate.as_view(), name="editar-status"),
    path('editar/situacao/', SituacaoUpdate.as_view(), name="editar-situacao"),
    path('editar/classe/', ClasseUpdate.as_view(), name="editar-classe"),
    path('editar/progressao/', ProgressaoUpdate.as_view(), name="editar-progressao"),
    path('editar/campo/', CampoUpdate.as_view(), name="editar-campo"),
    path('editar/atividade/', AtividadeUpdate.as_view(), name="editar-atividade"),
    path('editar/comprovante/', ComprovanteUpdate.as_view(), name="editar-comprovante"),
